...
class DXFAnalyzer:
    ...
    def verify_layer_properties(self, layer_name: str, expected_props: Dict[str, Any]) -> Dict[str, bool]:
        ...
        if "lineweight" in expected_props:
            ...
            actual_lineweight = layer.dxf.lineweight  # Use layer.dxf.lineweight for saved DXF files
...
class TestDXFIntegration:
    ...
    def test_line_entity_styling(self, style_applicator_service, comprehensive_styles, temp_dxf_file, dxf_document):
    ...
    def test_text_entity_styling(self, style_applicator_service, comprehensive_styles, temp_dxf_file, dxf_document):
    ...
    def test_polygon_with_hatch_styling(self, style_applicator_service, comprehensive_styles, temp_dxf_file, dxf_document):
    ...
    def test_combined_style_application(self, style_applicator_service, comprehensive_styles, temp_dxf_file, dxf_document):
    ...
    def test_all_entity_types_comprehensive(self, style_applicator_service, comprehensive_styles, temp_dxf_file, dxf_document):
    ...
    def test_edge_case_styles(self, style_applicator_service, comprehensive_styles, temp_dxf_file, dxf_document):
    ...
    def test_performance_large_dataset(self, style_applicator_service, comprehensive_styles, temp_dxf_file, dxf_document):
...
class TestDXFStyleVerification:
    ...
    def test_aci_color_resolution(self, style_applicator_service, color_mappings, temp_dxf_file, dxf_document):
    ...
    def test_linetype_creation(self, style_applicator_service, temp_dxf_file, dxf_document):
