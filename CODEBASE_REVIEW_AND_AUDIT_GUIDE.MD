...
*   The AI **MUST** explicitly incorporate this testing mandate (including execution and pass confirmation) into the "Guiding Principles & General Practices" section of the generated `REFACTORING_PLAN.MD`.
