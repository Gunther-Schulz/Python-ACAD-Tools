...
def create_envelope_layer(all_layers, project_settings, crs, layer_name, operation):
    ...
    def check_alignment_compatibility(poly1, poly2):
        ...
        # Get the direction to the next closest polygon
        angle = np.arctan2(vec[1], vec[0])
        return True  # For now, accept all nearby polygons
    ...
    for layer_info in source_layers:
        ...
        # Get all individual polygons
        all_polygons = get_all_polygons(source_gdf.geometry)
